...
<h1 class="text-8xl text-center font-bold text-thpink">Slither</h1>
<h2 class="text-3xl text-center font-semibold mb-16 text-thpink">QR Code Scanner</h2>
...
<div class="mx-auto max-w-md px-4">
    ...
    <button on:click={login} type="submit" class="mt-8 mx-auto block text-xl bg-thpink hover:bg-pink-400 text-white font-bold w-full py-1 rounded-lg {fetching ? "cursor-wait" : ""}">Login</button>
    {#if wrongCredentials}
